...
class SelectTestDialog(QDialog):
    def __init__(self, parent=None) -> None:
        ...
        self.setWindowTitle("Select Test Configuration")
        self.resize(900, 420)
    ...
    def _accept_row(self) -> None:
        ...
        if cr < 0:
            QMessageBox.information(self, "Select Test", "Select a row first.")
            return
        ...
        if rec is None:
            QMessageBox.warning(self, "Select Test", "Version was removed.")
            self._populate()
            return
        try:
